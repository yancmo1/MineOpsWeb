...
function EssencePlannerPanel({ managers, progress, entries }: { managers: CatalogManager[]; progress: PlayerManager[]; entries: PlayerInventoryEntry[] }) {
  ...
  return <section className="card-container essence-planner">
    ...
    {manager && !plan?.available && <div className="planner-data-warning"><strong>Rank costs unavailable for this manager in the active catalog.</strong><span>No complete rank recipe is available for this release, so no cost is estimated. Your inventory remains visible below.</span></div>}
