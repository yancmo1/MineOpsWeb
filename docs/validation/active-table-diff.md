...
| Metric | Value |
|---|---|
| APK managers (lossless-v2 `manager-domain.json`) | 119 |
| Matched to the curated reference (by game id) | 113 |
| Level rows compared (levels 1 and 100) | 113 |
| **Exact match** | **106** |
| Within 1% | 0 |
...
1. **The APK exact active tables are consistent with the community reference.** 106/113 matched managers agree at the compared levels to full precision — strong evidence the lossless extraction is correct. The new `10119` APK manager, Paige Cogsmith, is now included in the match.
