...
| Strategy | `StrategyEngine.swift`, `V2StrategyView.swift` | Deterministic lineup/boost plan; optional AI provider | `/strategy` | Owned roster, manager abilities | Disabled | Useful rules-first strategy with owned constraints | `VISUAL_REFERENCE/strategy.png` | Implement |
| More/settings | `V2MoreView.swift` | Sync, diagnostics, settings, exports, reset | `/more` | Sync metadata, auth, imports | Generic diagnostics | Protected settings and actionable errors | `VISUAL_REFERENCE/more.png` | Implement |
